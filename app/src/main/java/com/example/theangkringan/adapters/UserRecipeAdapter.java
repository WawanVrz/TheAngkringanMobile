...
public class UserRecipeAdapter extends RecyclerView.Adapter<UserRecipeAdapter.URecipeViewHolder> {
    ...
    @NonNull
    @Override
    public URecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_category_recipe, parent, false);
        return new URecipeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final URecipeViewHolder holder, int position) {
    ...
    public class URecipeViewHolder extends RecyclerView.ViewHolder {

        ImageView imgCover;
        TextView tvTitle;
        public URecipeViewHolder(@NonNull View itemView) {
            super(itemView);
